 ...
 * Each generated geometry gets an id under this Geometry based on its cell coordinates.
 *
 * @author Hans Haggstrom
 */
class GridGeneratorGeometry( cellGeometries : Geometry ) extends Geometry {
